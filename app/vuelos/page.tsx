...
type Vuelo = {
  ...
  origenCodigoPais: number;
  destinoCodigoPais: number;
...
const Vuelos = () => {
  ...
  const origenCodigoPaisRenderer = (origenCodigoPais: number) => {
          ...
          <div key={vuelo.id} className="my-6 px-4 pt-4 border rounded-xl text-text text-xl bg-white shadow-md shadow-primary/30">
            <div className="flex justify-between">
              <div className="text-lg max-w-xs w-full">
                ...
                <p>Destino: {vuelo.destinoCodigoPais}</p>
                <p className="text-sm">Aereolinea</p>
              </div>
